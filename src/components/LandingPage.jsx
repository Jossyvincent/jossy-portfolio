        ...
        <nav className='w-full fixed top-0 left-0 z-50'>
            <div className='max-w-xl mx-auto px-4 py-3 items-center flex justify-between'>
                ...
                <ul className='hidden md:flex space-x-8 text-sm font-medium'>
                    <li>
                        <a href='#home'className='hover:text-dominant transition'>Home</a>
                    </li>
                    <li>
                        <a href='#about' className='hover:text-dominant transition'>About</a>
                    </li>
                    <li>
                        <a href='#home' className='hover:text-dominant transition'>Projects</a>
                    </li>
                </ul>
